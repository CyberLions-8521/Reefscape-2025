...
public class Constants {
    ...
    public static class SwerveDrivebaseConstants {
        ...
        public static final double kFrontLeftCANCoderMagnetOffset  = -0.175049;
    ...
    public static class ElevatorConstants {
        ...
        public static final double kMaxHeight = 6.03; // Output revolutions
        public static final double kMinHeight = 0;    // Output revolutions
        public static final double kGearCircumference = Units.inchesToMeters(0);    // meters MUST BE CONFIGURED    
