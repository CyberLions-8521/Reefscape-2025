...
public class Shooter extends SubsystemBase {
  ...
  public Shooter(int masterID, int slaveID) {
    ...
    m_master.configure(ShooterConfigs.SHOOT_MASTER_CONFIG, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    m_slave.configure(ShooterConfigs.SHOOT_SLAVE_CONFIG, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
  }
